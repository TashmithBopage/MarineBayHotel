...
const imageMap = [
  {
    src: 'media_1788769999950.jpg',
    dest: 'rooms-hero.jpg',
    scale: 1.5
  },
  {
    src: 'media_1788770010158.jpg',
    dest: 'single-room.jpg',
    scale: 2.2
  },
  {
    src: 'media_1788770015955.jpg',
    dest: 'double-room.jpg',
    scale: 2.2
  },
  {
    src: 'media_1788770036748.jpg',
    dest: 'triple-room.jpg',
    scale: 2.2
  }
];
  ...
  for (const item of imageMap) {
    ...
    if (fs.existsSync(srcPath)) {
      try {
        ...
        // Fallback: direct copy if sharp fails
